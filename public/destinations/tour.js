...
function showCard() {
  ...
  cards.forEach((card) => {
    ...
    if (input === "switzerland") {
      ...
      switzerland.style.height = "730px";
      cardImg.style.height = "400px";
